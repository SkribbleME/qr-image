function matrix2path(matrix, degreeOfRandom) {
    ...
    function plot(row0, col0, dir, degreeOfRandom) {
...
function SVG(matrix, stream, margin, size, xcor, ycor, text) {
    colourDarkWheel = ["#fd6d21", "#2e2979", 'black', 'red']
    eyeCol = colourDarkWheel[Math.floor(Math.random() * (colourDarkWheel.length+1))]
    eyeSCol = colourDarkWheel[Math.floor(Math.random() * (colourDarkWheel.length+1))]
    dataSCol = colourDarkWheel[Math.floor(Math.random() * (colourDarkWheel.length+1))]
    dataCol = colourDarkWheel[Math.floor(Math.random() * (colourDarkWheel.length+1))]
    ...
    stream.push(designTemplate(matrix, "leaf", eyeCol, eyeSCol, 0.1,"#d5fd35", text))

...
function SVG(matrix, stream, margin, size, qrOptions, xcor, ycor, text) {
    ...
    eyeMainColor = qrOptions.eyeMainColor ? qrOptions.eyeMainColor : designAtt.SkribbleDefault.Main[0]
    eyeCol = qrOptions.eyeColor ? qrOptions.eyeColor : designAtt.SkribbleDefault.Eye[0]
    ...
    stream.push(designTemplate(matrix, qrOptions.eyeType, eyeCol, eyeMainColor, 0.1, eyeStrokeCol, text))
